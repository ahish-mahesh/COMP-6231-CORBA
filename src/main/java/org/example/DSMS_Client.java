...
public class DSMS_Client {
    ...
    public DSMS_Client(String[] args, String userID) {
        this.userID = userID;
    ...
    public void initializeServer(String args[]) {
        try {
            ...
            this.server = DSMSHelper.narrow(ncRef.resolve_str(this.relatedServer));
    ...
    public static void main(String[] args) {
        System.out.println("Welcome to DSMS Client!");
